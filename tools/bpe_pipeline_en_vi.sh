...
--best_model_file $OUT/models/model_best_$NAME.ckpt --data processed --batchsize 30 --tied --beam_size 5 \
--epoch 40 --layers 6 --multi_heads 8 --gpu 0 --metric bleu --wbatchsize 3000 \
