...
# Train
python ${AIAYN}/train.py -i ${AIAYN}/data/ja_en --data demo --batchsize 128 --tied --beam 5 --dropout 0.2 --epoch 40 \
--layer 1 --multi_heads 8 --gpu 0 --model_file "${AIAYN}/results/model.ckpt"
